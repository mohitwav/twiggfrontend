...
const PizzaItem = ({
  ...
  return (
    <ReactCardFlip isFlipped={flipped} flipDirection="vertical">
      ...
      >
        <Card.Section>
          <Image fit="fill" src={image}  withPlaceholder />
        </Card.Section>
    ...
    <Card
      ...
      >
        <Card.Section  >
          ...
          <Image fit="fill" src={image} height={190} withPlaceholder />
        ...
        <Button onClick={()=>handleClick()}   fullWidth
          radius="md"
          mt="xs"
          style={{ flex: 0.5 , flexDirection:"row" ,margin:"20px 10px 10px 10px" }}>Back</Button>
        <Button
          type="submit"
          ...
          radius="md"
          mt="xs"
          style={{ flex: 0.5 , flexDirection:"row" , margin:"20px 10px 10px 10px" }}
        >
          Add to cart
        </Button>
        </div>
